(function () {
    ...
    $(".itemlist-box").delegate(".itemlist-resultitembtn", "click", function (e) {
        ...
        window.getSuppliersList(taget.dataset.cid, function(){
            location.href = "../store/itemdetail.html?cid="+taget.dataset.cid+"&whLoc="+taget.dataset.wh;
        },'100000053000010');       
    })
    $(".itemlist-box").delegate(".itemlist-resultitemorder", "click", function (e) {
        var taget = e.currentTarget;
        location.href = "../store/itemorder.html";
    })
